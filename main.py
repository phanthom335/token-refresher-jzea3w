    """
    Token Refresher Jzea3w
    ======================
    Open-source API service that caches data between clients and backends.
    ...
    APP_NAME    = "Token Refresher Jzea3w"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source API service that caches data between clients and backends.")
